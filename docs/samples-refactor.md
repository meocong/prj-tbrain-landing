...
| ~~Hero copy~~ | **written.** "Data for models that have to act. / Human hands, robot arms, live play." Leads with purpose (R15) instead of listing our own taxonomy, which is now the chooser's job. Tam can swap the words; leaving the old line up while waiting was the wrong call. | R19 |
