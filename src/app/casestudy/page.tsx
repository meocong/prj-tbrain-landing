...
export default async function Page() {
  ...
  >
    {/* Hero Title Section */}
    <div className="w-full text-[#222222] text-4xl lg:text-5xl font-semibold leading-[52px] mb-4">
      Case Study: Agent Creation and Evaluation
    </div>
    <div className="text-lg text-[#222222] mb-12 italic">
      Delivering enterprise-grade AI agents at unprecedented speed
    </div>
  
    {/* Key Metrics Banner */}
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 text-center border-t-4 border-blue-600">
        <div className="text-4xl font-bold text-blue-600 mb-2">6</div>
        <div className="text-gray-600 text-sm">Production Agents</div>
      </div>
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 text-center border-t-4 border-indigo-600">
        <div className="text-4xl font-bold text-indigo-600 mb-2">1</div>
        <div className="text-gray-600 text-sm">Month Delivery</div>
      </div>
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 text-center border-t-4 border-purple-600">
        <div className="text-4xl font-bold text-purple-600 mb-2">720</div>
        <div className="text-gray-600 text-sm">Test Queries</div>
      </div>
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 text-center border-t-4 border-pink-600">
        <div className="text-4xl font-bold text-pink-600 mb-2">270</div>
        <div className="text-gray-600 text-sm">Curated Files</div>
      </div>
    </div>

    {/* About the Client */}
    <div className="mb-12">
      <h2 className="text-3xl font-bold text-[#222222] mb-6 border-l-4 border-blue-600 pl-4">
        About the Client
      </h2>
    ...
    {/* Objective */}
    <div className="mb-12 bg-blue-50/50 backdrop-blur-sm rounded-lg p-8">
      <h2 className="text-3xl font-bold text-[#222222] mb-6">Objective</h2>
    ...
    {/* Challenge */}
    <div className="mb-12">
      <h2 className="text-3xl font-bold text-[#222222] mb-6 border-l-4 border-indigo-600 pl-4">
        The Challenge
      </h2>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-lg">
            <div className="text-3xl font-bold text-indigo-700 mb-1">≥45</div>
            <div className="text-sm text-gray-700">files per agent</div>
          </div>
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg">
            <div className="text-3xl font-bold text-purple-700 mb-1">120</div>
      ...
      <div className="mb-5">
        <p className="text-[#222222] leading-relaxed mb-4">
          Each corpus mixed formats such as PDF, DOCX, PPTX, XLSX/CSV, HTML, and SharePoint pages, with layout variety like nested headings, footnotes, long tables, charts, and images. Files spanned small, medium, and large sizes, with spreadsheets featuring hundreds of rows across multiple worksheets.
        </p>
        <p className="text-[#222222] leading-relaxed">
          The query set had to feel human - covering fact-seeking, procedural, comparison, multi-part, hypothetical queries with varied clarity levels, realistic patterns like misspellings, domain-term paraphrases, and web-style phrasing. Many prompts required combining evidence across <span className="font-semibold text-indigo-600">2, 5, and 10+ documents</span>.
        </p>
      </div>
    </div>

    {/* Solution */}
    <div className="mb-12 bg-indigo-50/50 backdrop-blur-sm rounded-lg p-8">
      <h2 className="text-3xl font-bold text-[#222222] mb-6">Tbrain&apos;s Strategic Solution</h2>
      ...
      <h3 className="text-2xl font-bold text-[#222222] mb-4 mt-8">Five-Stage Workflow</h3>
      
      <div className="space-y-4">
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border-l-4 border-blue-500">
          ...
          <p className="text-[#222222] ml-11">Sourcing authentic documents, normalizing formats, removing duplicates - each agent holds <span className="font-semibold text-blue-600">≥45 files</span></p>
        </div>

        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border-l-4 border-indigo-500">
          <div className="flex items-center mb-2">
            <div className="w-8 h-8 bg-indigo-500 text-white rounded-full flex items-center justify-center font-bold mr-3">2</div>
            <h4 className="text-xl font-semibold text-[#222222]">Query Generation</h4>
          </div>
          <p className="text-[#222222] ml-11">Producing <span className="font-semibold text-indigo-600">~120 realistic prompts</span> per agent covering single and cross-document reasoning</p>
        </div>

        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border-l-4 border-purple-500">
          <div className="flex items-center mb-2">
          ...
          <p className="text-[#222222] ml-11">Attaching span-level evidence to every answerable query and marking unanswerable prompts for safe refusal</p>
        </div>

        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border-l-4 border-pink-500">
          <div className="flex items-center mb-2">
            <div className="w-8 h-8 bg-pink-500 text-white rounded-full flex items-center justify-center font-bold mr-3">4</div>
            <h4 className="text-xl font-semibold text-[#222222]">Quality Review</h4>
          </div>
          <p className="text-[#222222] ml-11">Enforcing rubric alignment, inter-rater checks, and policy verification for audit-ready outputs</p>
        </div>

        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border-l-4 border-red-500">
          <div className="flex items-center mb-2">
            <div className="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center font-bold mr-3">5</div>
            <h4 className="text-xl font-semibold text-[#222222]">Final Packaging</h4>
          </div>
          <p className="text-[#222222] ml-11">Assembling test-ready bundles approved by Team Leads for immediate handoff</p>
        </div>
      </div>
    </div>
    ...
    {/* Evaluation Rubric */}
    <div className="mb-12">
      <h2 className="text-3xl font-bold text-[#222222] mb-6 border-l-4 border-purple-600 pl-4">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 border-t-4 border-green-500">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 border-t-4 border-blue-500">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 border-t-4 border-red-500">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 border-t-4 border-purple-500">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 border-t-4 border-pink-500">
    ...
    {/* Outcome */}
    <div className="mb-12 bg-green-50/50 backdrop-blur-sm rounded-lg p-8">
      <h2 className="text-3xl font-bold text-[#222222] mb-6">Outcome & Impact</h2>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <div className="text-5xl font-bold text-blue-600 mb-2">270</div>
          ...
          <div>
            <div className="text-5xl font-bold text-indigo-600 mb-2">720</div>
