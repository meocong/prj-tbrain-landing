...
export const metadata: Metadata = {
  title: "Tbrain - AI Agent Creation Case Studies",
    ...
    <div>
      ...
      >
        ...
        <section className="container mx-auto px-3 pt-24 pb-24 relative max-w-[1128px]">
          ...
          {/* CTA */}
          <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-8 text-center text-white shadow-xl">
           ...
           <a
              ...
              className="inline-flex items-center gap-3 bg-white text-purple-700 font-bold py-3 px-8 rounded-lg hover:bg-purple-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 group"
            >
