...
export default async function ServicesAdminPage({
  ...
  const initial = await listAdminResource<ServiceRow>(
    {
      table: "services",
      ...
      // Domains live under /admin/domains — scope this listing to "service".
      where: (q) => q.eq("category", "service"),
    },
    sp
  );
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--text-muted)" }}>
            Service cards shown on /services. Edit titles, descriptions, and icons.
          </p>
        </div>
