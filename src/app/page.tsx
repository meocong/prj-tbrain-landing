...
export const metadata: Metadata = {
  ...
  description:
    "Lab-grade, action-paired robot training data — egocentric, UMI, teleoperation — captured on our own purpose-built hardware (Intel RealSense, GoPro), QC'd by an AI-native pipeline, delivered RLDS-ready for Physical AI.",
    ...
    <section className="bp-grid bp-frame relative overflow-hidden" style={{ paddingTop: 92, paddingBottom: 100 }}>
      ...
      <div className="container relative z-10 mx-auto max-w-3xl px-5 text-center">
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link href="/data/physical-ai" className="inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-bold" style={{ fontFamily: "var(--font-heading)", color: "var(--bp-ink)", border: "1px solid var(--bp-line-strong)" }}>How the foundry works</Link>
        </div>
      </div>
    </section>
  );
