...
export const REAL_SAMPLES = {
  ...
  groups: {
    ...
    TEXTILE: { label: "Textile factory", note: "8 raw egocentric captures · annotation downstream" },
  },
  items: [
    // Kitchen · PASS (5)
    ...
    { group: "TEXTILE", name: "Ironing · T01",                 skill: "iron_product_01",         video: "/videos/textile-raw/iron_01.webm",     poster: "/images/textile-raw/iron_01.jpg",     note: "Egocentric · anchor hand right · object pants",        frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label running downstream" } },
    { group: "TEXTILE", name: "Ironing · T02",                 skill: "iron_product_02",         video: "/videos/textile-raw/iron_02.webm",     poster: "/images/textile-raw/iron_02.jpg",     note: "Egocentric · sewing-line manipulation · label pending re-prompt", frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · SAM re-prompt queued downstream" } },
    { group: "TEXTILE", name: "Sew on hem machine",            skill: "sew_hem_02",              video: "/videos/textile-raw/sew_02.webm",      poster: "/images/textile-raw/sew_02.jpg",      note: "Egocentric · both-hand manipulation · object cloth",        frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label running downstream" } },
    { group: "TEXTILE", name: "Fabric sort + feed · T01",      skill: "arrange_fabric_01",       video: "/videos/textile-raw/arrange_01.webm",  poster: "/images/textile-raw/arrange_01.jpg",  note: "Egocentric · both-hand manipulation · object cloth",        frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label running downstream" } },
    { group: "TEXTILE", name: "Fabric sort + feed · T02",      skill: "arrange_fabric_02",       video: "/videos/textile-raw/arrange_02.webm",  poster: "/images/textile-raw/arrange_02.jpg",  note: "Egocentric · fabric sort · label pending SAM re-seed", frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · SAM re-prompt queued downstream" } },
    { group: "TEXTILE", name: "Package into bag · T02",        skill: "package_product_02",      video: "/videos/textile-raw/package_02.webm",  poster: "/images/textile-raw/package_02.jpg",  note: "Egocentric · package into bag · cloth + plastic bag", frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label running downstream" } },
    { group: "TEXTILE", name: "Sew on hem machine · T01",      skill: "sew_hem_01",              video: "/videos/textile-raw/sew_01.webm",      poster: "/images/textile-raw/sew_01.jpg",      note: "Egocentric · high-motion sewing · auto-label re-track queued",       frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label re-track queued downstream" } },
    { group: "TEXTILE", name: "Package into bag · T01",        skill: "package_product_01",      video: "/videos/textile-raw/package_01.webm",  poster: "/images/textile-raw/package_01.jpg",  note: "Egocentric · warehouse packaging · auto-label re-track queued",         frames: 450, seconds: 15, sensor: "Wearable capture pack", qc: { state: "PARTIAL", passCount: 0, total: 14, note: "Raw source · auto-label re-track queued downstream" } },
  ] as RealSample[],
} as const;
