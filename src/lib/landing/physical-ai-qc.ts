...
export const AUTO_LABEL_STAGES: StageCard[] = [
  ...
  },
  {
    ...
    detail: "Whole-body dense keypoint regression. Skeleton + face + hand landmarks in one pass. Feeds retargeting to humanoid and dexterous robot topologies.",
    output: "body_dense · kpts (N × 308 × 3) · conf",
    overlayImages: [
