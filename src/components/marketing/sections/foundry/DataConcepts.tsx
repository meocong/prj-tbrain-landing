...
const CONCEPTS = [
  ...
  },
  {
    ...
    lead: "labels.json.models records the model + version + git SHA that produced each field. A rerun with a newer model produces a new labels.json; the diff is machine-readable. No silent overwrites, no black-box updates.",
  ...
  },
  {
    ...
    icon: ScaleIcon,
    fig: "06",
    title: "Versioning · schema_v3 + capture_id",
    ...
    keys: ["schema_version: 3.0", "capture_id: task__op__ts", "additive migrations"],
  },
  {
    key: "augmentation",
    icon: Sparkles,
